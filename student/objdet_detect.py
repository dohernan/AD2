        ...
        if 'darknet' in configs.arch:
            ...
            for sample_i in range(len(output_post)):
                ...
                for obj in detection:
                    ...
                    detections2.append([1, x, y, 0.0, 1.50, w, l, yaw])    
            ...
            for object in detections[0][1]:
                _score, x, y, z, h, w, l, yaw = object
                detections2.append([1, x, y, z, h, w, l, yaw])
            ####### ID_S3_EX1-5 START #######     
            #######
